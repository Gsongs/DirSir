 ...
 *用途：
 */
class Fragment_tel extends BaseFragment implements FoodCollter.FoodView {
    private RecyclerView ress;
    String page1="小米手机",page2="小米";
    Integer page3=20,page4=20;
    FoodPresenter foodPresenter;
    List<String> smallImages;
    @Override
    public int bandLayout() {
        return R.layout.fragment_towa;
    }
    ...
    public void initView() {
        ...
        ress.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
