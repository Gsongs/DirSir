 ...
 *用途：
 */
class Fragment_trip extends BaseFragment implements FoodCollter.FoodView {

    FoodPresenter foodPresenter;
    String page1 = "生活旅行", page2 = "生活旅行";
    Integer page3 = 25, page4 = 25;
    private RecyclerView resfiveb;
    List<String> smallImages;

    @Override
    public int bandLayout() {
        return R.layout.fragment_fiveb;
    }

    @Override
    public void initView() {

        resfiveb = (RecyclerView) findViewById(R.id.resfiveb);


        resfiveb.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
