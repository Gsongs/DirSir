 ...
 *用途：
 */
class Fragment_computer extends BaseFragment implements FoodCollter.FoodView {

    FoodPresenter foodPresenter;
    String page1 = "笔记本电脑", page2 = "电脑";
    Integer page3 = 20, page4 = 20;
    private RecyclerView res;
    List<String> smallImages;
    @Override
    public int bandLayout() {
        return R.layout.fragment_onea;
    }
    ...
    public void initView() {
        ...
        res.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
