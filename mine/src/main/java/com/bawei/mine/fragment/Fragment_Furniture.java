 ...
 *用途：
 */
class Fragment_Furniture extends BaseFragment implements FoodCollter.FoodView {

    FoodPresenter foodPresenter;
    String page1 = "家具", page2 = "家具";
    Integer page3 = 25, page4 = 25;
    private RecyclerView resthreeb;
    List<String> smallImages;

    @Override
    public int bandLayout() {
        return R.layout.fragment_threeb;
    }

    @Override
    public void initView() {

        resthreeb = (RecyclerView) findViewById(R.id.resthreeb);

        resthreeb.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
