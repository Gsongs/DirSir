 ...
 *用途：
 */
class Fragment_toy extends BaseFragment implements FoodCollter.FoodView {

    FoodPresenter foodPresenter;
    String page1 = "玩具乐器", page2 = "玩具乐器";
    Integer page3 = 25, page4 = 25;
    private RecyclerView resoneb;
    List<String> smallImages;
    @Override
    public int bandLayout() {
        return R.layout.fragment_oneb;
    }

    @Override
    public void initView() {

        resoneb = (RecyclerView) findViewById(R.id.resoneb);


        resoneb.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
