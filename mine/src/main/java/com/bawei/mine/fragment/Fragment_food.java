 ...
 *用途：
 */
class Fragment_food extends BaseFragment implements FoodCollter.FoodView {
    private RecyclerView ressix;
    FoodPresenter foodPresenter;
    String page1 = "食品生鲜", page2 = "食品生鲜";
    Integer page3 = 25, page4 = 25;
    List<String> smallImages;
    @Override
    public int bandLayout() {
        return R.layout.fragment_sixa;
    }

    @Override
    public void initView() {

        ressix = (RecyclerView) findViewById(R.id.ressix);



        ressix.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
