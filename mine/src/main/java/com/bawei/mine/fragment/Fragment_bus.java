...
class Fragment_bus extends BaseFragment implements FoodCollter.FoodView {

    FoodPresenter foodPresenter;
    String page1 = "汽车用品", page2 = "汽车用品";
    Integer page3 = 25, page4 = 25;
    private RecyclerView restowb;
    List<String> smallImages;

    @Override
    public int bandLayout() {
        return R.layout.fragment_towb;
    }

    @Override
    public void initView() {
        restowb = (RecyclerView) findViewById(R.id.restowb);

        restowb.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
