 ...
 *用途：
 */
class Fragment_man extends BaseFragment implements FoodCollter.FoodView {
    FoodPresenter foodPresenter;
    String page1 = "男士冬季", page2 = "男装";
    Integer page3 = 25, page4 = 25;
    private RecyclerView resss;
    List<String> smallImages;
    @Override
    public int bandLayout() {
        return R.layout.fragment_threeaa;
    }

    @Override
    public void initView() {

        resss = (RecyclerView) findViewById(R.id.resss);

        resss.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
