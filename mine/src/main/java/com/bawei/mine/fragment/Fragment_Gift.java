 ...
 *用途：
 */
class Fragment_Gift extends BaseFragment implements FoodCollter.FoodView {

    FoodPresenter foodPresenter;
    String page1 = "礼品鲜花", page2 = "礼品鲜花";
    Integer page3 = 25, page4 = 25;
    private RecyclerView resforb;
    List<String> smallImages;

    @Override
    public int bandLayout() {
        return R.layout.fragment_forb;
    }
    ...
    public void initView() {
        ...
        resforb = (RecyclerView) findViewById(R.id.resforb);


        resforb.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
