 ...
 *用途：
 */
class Fragment_woman extends BaseFragment implements FoodCollter.FoodView {
    private RecyclerView resfor;
    FoodPresenter foodPresenter;
    String page1 = "冬季女装", page2 = "女装";
    Integer page3 = 25, page4 = 25;
    List<String> smallImages;
    @Override
    public int bandLayout() {
        return R.layout.fragment_fora;
    }

    @Override
    public void initView() {

        resfor = (RecyclerView) findViewById(R.id.resfor);

        foodPresenter = new FoodPresenter(new FoodModel(), this);

        resfor.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
    }
