 ...
 *用途：
 */
class LiveActivity_three extends BaseActivity {
    ...
    public int bandLayout() {
        return R.layout.liveactivity_three;
    }
    ...
    public void initData() {
        ...
        //关键 player 对象与界面 view
        mLivePlayer.setPlayerView(videoView);
        String flvUrl = "http://103.18.208.185/liveplay-kk.rtxapp.com/live/program/live/hnwshd/2300000/mnf.m3u8";
